...
ActiveRecord::Schema[7.0].define(version: 2023_05_10_181130) do
  ...
  create_table "issue_user_modifications", force: :cascade do |t|
    t.integer "issue_id"
    t.integer "user_id"
  ...
  create_table "issues", force: :cascade do |t|
    ...
    t.string "watchers"
    t.integer "typeIssue"
    t.integer "severityIssue"
    t.integer "priorityIssue"
    t.integer "statusIssue"
    t.integer "user_id"
    t.integer "createdBy"
  end
